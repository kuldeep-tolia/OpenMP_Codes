! OpenMP program to solve given 2D Poisson equation using Gausss-Seidel method with red-black coloring way of traversing grid points
program openmp_red_black_gauss_seidel
...
implicit none
	...
	do while (global_error .ge. tolerance)
		...
		! Gauss-Seidel iterative solver with red-black coloring way of traversing grid points
		!$omp do collapse(2)
		do j = 1, N-1
			do i = 1, N-1
...
end program openmp_red_black_gauss_seidel

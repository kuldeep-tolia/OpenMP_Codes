! OpenMP program to demonstrate how to parallelize a do loop using coarse grain threading approach instead of using omp_do construct
program coarse_grain_parallelism

use omp_lib
implicit none

	integer :: num_threads = 4, istart, iend, thread_id, i, points_per_thread
